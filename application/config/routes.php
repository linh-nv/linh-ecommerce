...
// ----------------------------------------------public-----------------------------------------
$route['danh-muc']['GET'] = 'IndexController/categoryAll';
$route['thuong-hieu']['GET'] = 'IndexController/brandAll';
...
$route['gio-hang/(:any)']['GET'] = 'IndexController/cart/$1';
$route['add-to-cart']['POST'] = 'IndexController/add_to_cart';
$route['delete-all-cart/(:any)']['GET'] = 'IndexController/delete_all_cart/$1';
...
$route['dang-ky-user']['POST'] = 'IndexController/dang_ky';
$route['checkout']['GET'] = 'IndexController/checkout';
$route['confirm-checkout']['POST'] = 'IndexController/confirm_checkout';
$route['update-adress/(:any)']['POST'] = 'IndexController/update_adress/$1';
$route['update-password/(:any)']['POST'] = 'IndexController/update_password/$1';
$route['thank']['GET'] = 'IndexController/thank';
$route['tim-kiem']['GET'] = 'IndexController/tim_kiem';
$route['forgot-password']['GET'] = 'IndexController/forgot_password';
$route['forgot-password-post']['POST'] = 'IndexController/forgot_password_post';
$route['aboutUs']['GET'] = 'IndexController/about_Us';
$route['login-customer']['POST'] = 'IndexController/login_customer';

// test================================================
$route['test']['GET'] = 'TestController/index';
...
$route['thong-tin-nguoi-dung/(:any)']['GET'] = 'IndexController/customer_infor/$1';
//dashboard
...
$route['order/update-status/(:any)']['GET'] = 'OrderController/updateStatus/$1';
$route['order/update-status-cancel/(:any)']['GET'] = 'OrderController/updateStatus_Cancel/$1';
